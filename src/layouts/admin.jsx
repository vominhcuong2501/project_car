  ...
  return (
    ...
    >
      <Sider trigger={null} collapsible collapsed={collapsed}>
        <div className="logo p-3 my-3 d-flex justify-content-between align-items-end" style={{width: "240px"}}>
          <NavLink to="/admin">
            <img
        ...
        className="mt-3 px-3"
          ...
          items={[
            getItem("Car Brand", "1", <i className="fa-solid fa-car-side"></i>),
            getItem("Folder", "sub1", <i className="fa-solid fa-folder"></i>, [
              getItem("Menu Item", "2"),
              getItem("Menu Item", "3"),
              getItem("Menu Item", "4"),
              getItem("Menu Item", "5"),
            ...
            getItem("Notifications", "8", <i className="fa-solid fa-folder"></i>)
          ]}
        />
      </Sider>
